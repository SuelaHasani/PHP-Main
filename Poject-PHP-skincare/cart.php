...
// Merr ID e produktit nga POST dhe shto në shportë
...
// Lidhja me databazën për të marrë të dhënat e produkteve
    ...
    <?php else: ?>
        <table class="cart-table">
            ...
            <?php foreach ($cartItems as $item): ?>
                <tr>
                    <td><img src="images/images.jpg" alt="<?php echo htmlspecialchars($item['name']); ?>"></td>
        ...
        <div class="cart-total">
            Totali: <strong><?php echo $total; ?> Euro</strong>
        </div>
    <?php endif; ?>
